...
class CarInterface(CarInterfaceBase):
  ...
  def get_params(candidate, fingerprint=gen_empty_fingerprint(), car_fw=[]):  # pylint: disable=dangerous-default-value
    ...
    # hyundai
      ...
      ret.wheelbase = 2.84
      ret.steerRatio = 10.2 * 1.15   # 15% higher at the center seems reasonable
      ...
      ret.wheelbase = 2.7
      ret.steerRatio = 10.2            # 14 is Stock | Settled Params Learner values are steerRatio: 10.201566348670535
      ...
      ret.lateralTuning.pid.kiBP, ret.lateralTuning.pid.kpBP = [[0.], [0.]]
      ret.lateralTuning.pid.kpV, ret.lateralTuning.pid.kiV = [[0.16], [0.02]]
    elif candidate in [CAR.KONA_HEV, CAR.KONA_EV]:
      ret.mass = 1685. + STD_CARGO_KG
      ret.wheelbase = 2.7
      ret.steerRatio = 12.5
      tire_stiffness_factor = 0.885
    ...
    # kia
      ...
      ret.wheelbase = 2.78
      ret.steerRatio = 10.2 * 1.1   # 10% higher at the center seems reasonable
      ret.lateralTuning.pid.kf = 0.00005
      ret.lateralTuning.pid.kiBP, ret.lateralTuning.pid.kpBP = [[0.], [0.]]
      ret.lateralTuning.pid.kpV, ret.lateralTuning.pid.kiV = [[0.25], [0.05]]
